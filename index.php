...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Login Page - Quest Connect</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Quest</span>
									<span class="white">Connect</span>
								</h1>
								<h4 class="blue">&copy; Quest Alliance</h4>
							</div>
										...
										<div class="widget-main">
											...
											<form id="f1">
												<fieldset>
													...
													<div class="p" type="hidden" size=128></div>

													<div class="error-block" type="hidden"></div>
								...
								<div id="forgot-box" class="forgot-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="space-6"></div>
											<p>
												Enter your email or Mobile no to receive instructions
											</p>
